<div id="finalResultsPane">
  ...
  <div id="fr_roster">
    <div class="row g-2 mb-2 align-items-end">
      <div class="col-6 col-md-3">
        <label class="form-label small">Attendance/Grade/Comment from Term</label>
        <select class="form-select form-select-sm" id="fr_rosterTerm"></select>
      </div>
      <div class="col-6 col-md-2">
        <label class="form-label small">Report</label>
        <select class="form-select form-select-sm" id="fr_rosterReport">
    ...
    <p class="text-muted small">Recomputes and persists rank, highest-in-class, and final totals for this class. Marks/rank aggregate every scheduled term; attendance, grade and comment come from the term/report selected above.</p>
